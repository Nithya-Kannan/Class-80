...
function sorting() {
   ...
   console.log(name_of_the_student_array);
   var display_sorted_student_array=[];
   var length_of_student_array=name_of_the_student_array.length;
   console.log(length_of_student_array);
   
   for(var k=0;k<length_of_student_array;k++){
       display_sorted_student_array.push("<h4> NAME -"+ name_of_the_student_array[k]+"</h4>");
       console.log(display_sorted_student_array);
   }
   var remove_commas=display_sorted_student_array.join(" ");
   console.log(remove_commas);
   document.getElementById("display_name_without_commas").innerHTML=remove_commas;
